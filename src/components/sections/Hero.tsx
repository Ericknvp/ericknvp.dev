      ...
      <div className="max-w-6xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <div className="order-2 md:order-1">
          ...
          >
            <a
              href="#projects"
              className="glass px-7 py-3 rounded-full text-sm font-medium border border-[var(--glass-border)] hover:border-[var(--accent)]/60 hover:bg-[var(--card-hover)] transition-all duration-300"
              style={{ color: 'var(--fg)' }}
            >
              {t.hero.cta_projects}
            </a>
            ...
            <a
              href="#contact"
              className="btn-accent px-7 py-3 rounded-full text-white text-sm font-medium"
            >
              {t.hero.cta_contact}
            </a>
